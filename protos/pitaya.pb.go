...
type PitayaClient interface {
	...
	PushToUsers(ctx context.Context, in *MultiPush, opts ...grpc.CallOption) (*Response, error)
...
func (c *pitayaClient) PushToUsers(ctx context.Context, in *MultiPush, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/protos.Pitaya/PushToUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PitayaServer interface {
	...
	PushToUsers(context.Context, *MultiPush) (*Response, error)
...
func (UnimplementedPitayaServer) PushToUsers(context.Context, *MultiPush) (*Response, error) {
...
func _Pitaya_PushToUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MultiPush)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PitayaServer).PushToUsers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.Pitaya/PushToUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PitayaServer).PushToUsers(ctx, req.(*MultiPush))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Pitaya_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Pitaya_PushToUsers_Handler,
		},
		{
